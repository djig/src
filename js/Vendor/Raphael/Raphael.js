...
function (t, e) {
            ...
            if (h) h.initstatus = a, h.start = new Date - h.ms * a;
                ...
                for (var C in l) if (l[B](C) && (ie[B](C) || i.paper.customAttributes[B](C))) switch (v[C] = i.attr(C), null == v[C] && (v[C] = re[C]), y[C] = l[C], ie[C]) {
                    ...
                    case "transform":
                        ...
                        if (z) for (v[C] = z.from, y[C] = z.to, m[C] = [], m[C].real = !0, _ = 0, k = v[C].length; k > _; _++) for (m[C][_] = [v[C][_][0]], N = 1, L = v[C][_].length; L > N; N++) m[C][_][N] = (y[C][_][N] - v[C][_][N]) / g;
                        else {
    ...
    r.color = function (t) {
        ...
        return r.is(t, H) && r.is(t[0], H) && (n = Ae(t)), n.length || F(t).replace(oe, function (t, e, r) {
            ...
            else for (; a.length >= i[s] && (n.push([e][E](a.splice(0, i[s]))), i[s]) ;);
    ...
    var Te = r.pathBBox = function (t) {
        ...
        t = Re(t);
        for (var r, n = 0, a = 0, s = [], o = [], l = 0, h = t.length; h > l; l++) if (r = t[l], "M" == r[0]) n = r[1], a = r[2], s.push(n), o.push(a);
        else {
    ...
    function (t) {
        ...
        t.add = function (t, e, r, i, n, a) {
            ...
            //this fix is to make sure Scale should not exceed more than 1.1 which is normal
            //this is to prevent scalling more than 1.1 for pie charts----Jignesh DHamecha
            if (this.a > 1.1) {
    ...
    _.finger = function (x, y, width, height, dir, ending, isPath) {
    ...
    _.labelise = function (label, val, total) {
        if (label) {
                        ...
                        for (var v in u) if (u[B](v)) {
                            switch (ie[v]) {
                                ...
                                case "path":
                                    ...
                                    break;
                                case "transform":
                                    if (c[v].real) for (a = [], m = 0, b = u[v].length; b > m; m++) for (a[m] = [u[v][m][0]], _ = 1, w = u[v][m].length; w > _; _++) a[m][_] = u[v][m][_] + x * l * c[v][m][_];
                                    else {
                                        var k = function (t) {
    ...
    return fr.attr = function (t, e) {
        if (t && r.is(t, H) && r.is(t[0], "object")) for (var i = 0, n = t.length; n > i; i++) this.items[i].attr(t[i]);
        else for (var a = 0, s = this.items.length; s > a; a++) this.items[a].attr(t, e);
        return this
    }, fr.clear = function () {
        ...
        if (r.svg) {
            ...
            B.prototype = S, S.constructor = B, r._engine.path = function (t, e) {
                ...
                return this.transform(this._.transform.concat([
                 ...
                 //console.log("scale222 :" + t + " - r:" + r + " - n:" + n + " - a:" + a);
                ...
                if (e != 1) {
                    ...
                    if (e.id == "markValueEntity") {

                        //s = 200;
                        //a = 920;

                    }
                    if (e.id == "markValueStrategy"  ) {
                        //s = 200;
                        //a = 560;
                ...
                //return i = i || 0, n = n || 0, a = a || 512, s = s || 342, x(l, {
                    return i = i || 0, n = n || 0, a = a || 512, s = s || 142, x(l, {
                    height: s,
                    version: 1.1,
                    width: a,
        ...
        if (r.vml) {
            ...
            var S = function (t, r, i) {
                ...
                if (x && (f.path = r._getPath[n.type](n), n._.dirty = 1), l.href && (c.href = l.href), l.title && (c.title = l.title), l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || x) && (c.path = k(~e(f.path).toLowerCase().indexOf("r") ? r._pathToAbsolute(f.path) : f.path), "image" == n.type && (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height], B(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), v) {
                    var C = +f.cx,
                        ...
                        N = +f.rx || +f.r || 0,
                        E = +f.ry || +f.r || 0;
                    c.path = r.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((C - N) * b), a((T - E) * b), a((C + N) * b), a((T + E) * b), a(C * b))
                }
                if ("clip-rect" in l) {
            ...
            N.prototype = E, E.constructor = N, E.transform = function (t) {
                ...
                var e = this.node.runtimeStyle,
                    i = e.filter;
                i = i.replace(v, d), 0 !== +t ? (this.attrs.blur = t, e.filter = i + p + f + ".Blur(pixelradius=" + (+t || 1.5) + ")", e.margin = r.format("-{0}px 0 0 -{0}px", a(+t || 1.5))) : (e.filter = i, e.margin = 0, delete this.attrs.blur)
            ...
            r._engine.initWin = function (t) {
                ...
                return a = a || 0, s = s || 0, n = n || 512, i = i || 112, o.width = n, o.height = i, n == +n && (n += "px"), i == +i && (i += "px"), o.coordsize = 1e3 * b + p + 1e3 * b, o.coordorigin = "0 0", o.span = r._g.doc.createElement("span"), o.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;", l.appendChild(o.span), h.cssText = r.format("top:0;left:0;width:{0};height:{1};display:inline-block;position:relative;clip:rect(0 {0} {1} 0);overflow:hidden", n, i), 1 == e ? (r._g.doc.body.appendChild(l), h.left = a + "px", h.top = s + "px", h.position = "absolute") : e.firstChild ? e.insertBefore(l, e.firstChild) : e.appendChild(l), o.renderfix = function () { }, o
